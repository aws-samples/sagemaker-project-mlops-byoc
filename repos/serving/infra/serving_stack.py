...
from infra.model_async_endpoint_construct import ModelAsyncEndpointConstruct
        ...
        **kwargs,
        ...
        for k in configuration_path.glob("*.model.json"):
            ...
            for endpoint_conf in model_conf["endpoints"]:
                if endpoint_conf["type"] == "asynchronous":
                    ModelAsyncEndpointConstruct(
                        self,
                        f"AsyncEndpoint-{endpoint_conf['endpoint_name']}",
                        model_package_group_name=model_package_group_name,
